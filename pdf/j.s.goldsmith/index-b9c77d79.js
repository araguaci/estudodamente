...
const Ro = (e, t) => {
  ...
  dc = {
    ...
    methods: {
      openPdf() {
        const e = 'a-arte-de-curar-pelo-espirito.pdf';
        window.open(`/pdf/j.s.goldsmith/${e}`, '_self');
      },
    },
  };
...
const bf = Ro(yf, [['render', vf]]),
  xf = mf({ history: kc(), routes: [{ path: '/pdf/j.s.goldsmith/a-arte-de-curar-pelo-espirito', component: bf }] });
