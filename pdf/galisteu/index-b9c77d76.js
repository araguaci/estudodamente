...
const Ro = (e, t) => {
  ...
  dc = {
    ...
    methods: {
      openPdf() {
        const e = 'meus_405_dias_ao_lado_de_ayrton_senna.pdf';
        window.open(`/pdf/galisteu/${e}`, '_self');
      },
    },
  };
...
const bf = Ro(yf, [['render', vf]]),
  xf = mf({ history: kc(), routes: [{ path: '/pdf/galisteu/meus_405_dias_ao_lado_de_ayrton_senna', component: bf }] });
